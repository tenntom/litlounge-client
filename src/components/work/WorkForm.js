...
export const WorkForm = () => {
    ...
    return (
        <form className="work-form">
            <div className="work-form-inside">
                {
                    (workId)
                                ...
                                genres.map(g => {
                                    return (
                                        <>
                                            ...
                                            />
                                            <label htmlFor="workGenre" className="genre-items">{g.label}</label>
                                        </>
                                    )
                                })
                            }
                        ...
                        (workId)
                            ? <div className="edit-buttons">
                                <button type="submit"
                                    ...
                                    className="btn-btm">Update</button>
                                <button className="btn-btm" onClick={e => {
                                    e.preventDefault()
                                ...
                                <button type="cancel" onClick={evt => {
                                    history.push("/works")
                                }} className="btn-btm">Cancel</button>
                            </div>
                            :
                            <div><button type="submit"
                                ...
                                className="btn-btm">Create</button>
                                <button type="cancel" onClick={evt => {
                                    history.push("/works")
                                }} className="btn-btm">Cancel</button>
                            </div>
